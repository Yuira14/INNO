...
var lyr_llocs_1 = new ol.layer.Vector({
    ...
    <img src="styles/legend/llocs_1_11.png" /> <br />'
        });

lyr_OpenStreetMap_0.setVisible(true);lyr_llocs_1.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_llocs_1];
lyr_llocs_1.set('fieldAliases', {'id': 'id', 'N_Taules': 'N_Taules', 'N_Llocs': 'N_Llocs', 'Facultat': 'Facultat', 'Ocupació': 'Ocupació', });
lyr_llocs_1.set('fieldImages', {'id': 'TextEdit', 'N_Taules': 'TextEdit', 'N_Llocs': 'TextEdit', 'Facultat': '', 'Ocupació': '', });
lyr_llocs_1.set('fieldLabels', {'id': 'inline label', 'N_Taules': 'inline label', 'N_Llocs': 'inline label', 'Facultat': 'inline label', 'Ocupació': 'inline label', });
